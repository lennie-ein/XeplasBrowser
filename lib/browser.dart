...
import 'package:browser_xeplas/tab_viewer.dart';
import 'package:browser_xeplas/app_bar/browser_app_bar.dart';
...
class _BrowserState extends State<Browser> with SingleTickerProviderStateMixin {
  ...
  static const platform = const MethodChannel('com.pichillilorenzo.browser_xeplas.intent_data');
