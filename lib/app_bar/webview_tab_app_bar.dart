...
import 'package:browser_xeplas/app_bar/url_info_popup.dart';
import 'package:browser_xeplas/custom_image.dart';
import 'package:browser_xeplas/main.dart';
import 'package:browser_xeplas/models/browser_model.dart';
import 'package:browser_xeplas/models/favorite_model.dart';
import 'package:browser_xeplas/models/web_archive_model.dart';
import 'package:browser_xeplas/models/webview_model.dart';
import 'package:browser_xeplas/pages/developers/main.dart';
import 'package:browser_xeplas/pages/settings/main.dart';
import 'package:browser_xeplas/tab_popup_menu_actions.dart';
import 'package:browser_xeplas/util.dart';
          ...
          return Selector<WebViewModel, bool>(
              ...
              builder: (context, isIncognitoMode, child) {
                return leading != null
                    ? AppBar(
                        backgroundColor:
                            isIncognitoMode ? Colors.black87 : Color(0xFF98777b),
